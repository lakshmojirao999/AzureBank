{
    ...
    "Description": "GuideWire IIS App Server with Windows 2012",
    "Parameters": {
        "pAppServerKeyName": {
        ...
        "pAppServerInstanceType": {
            "Description": "AppServer Server EC2 instance type",
            "Type": "String"
        },
        "pVPCID": {
            "Type": "String",
        ...
        "pappPrivateSubnetIDAZ1": {
            "Type": "String",
            "Description": "The App serverPrivate SubNet ID for AZ1"
        },
        "pappPrivateSubnetAZ1": {
            "Type": "String",
            "Description": "The App server Private SubNet Availability Zone1"
        },
        ...
        "pappPrivateSubnetAZ2": {
            "Type": "String",
            "Description": "The App server Private SubNet Availability Zone2"
        }
    },
    "Resources": {
        "InstanceProfile": {
        ...
        "AppServerELB": {
            "Properties": {
                "AvailabilityZones": [
                    {
                        "Ref": "pappPrivateSubnetAZ1"
                    },
                    {
                        "Ref": "pappPrivateSubnetAZ2"
                    }
                ],
                "HealthCheck": {
                    "Target": "HTTP:80/",
        ...
        "rcmAppServerLCWaitCondition": {
            "Type": "AWS::CloudFormation::WaitCondition",
            "DependsOn": "rcmAppServerLaunchConfig",
            "Properties": {
                "Handle": {
                    "Ref": "rcmAppServerLCWaitHandle"
                },
                "Timeout": "1800"
            },
            "Metadata": {
        ...
        "rcmAppServerFleet": {
            "Properties": {
                ...
                "VPCZoneIdentifier": [
                    {
                        "Ref": "pappPrivateSubnetIDAZ1"
                    },
                    {
                        "Ref": "pappPrivateSubnetIDAZ2"
                    }
                ],
                "Tags": [
                    {
                        "Key": "Name",
                        "Value": "rcmAppServerFleet",
                        "PropagateAtLaunch": "true"
                    }
                ],
                "LaunchConfigurationName": {
                    "Ref": "rcmAppServerLaunchConfig"
                },
                "LoadBalancerNames": [
                    {
                        "Ref": "AppServerELB"
                                ...
                                "content": {
                                    "Fn::Join": [
                                        ...
                                        [
                                            ...
                                            "path=Resources.rcmAppServerLaunchConfig.Metadata.AWS::CloudFormation::Init\n",
                                            "action=cfn-init.exe -v -c deploy -s ",
                                            {
                                                "Ref": "AWS::StackId"
                                            },
                                            " -r rcmAppServerLaunchConfig",
                                            " --region ",
                                            {
                                                "Ref": "AWS::Region"
                                            },
        ...
        "rccAppServerLCWaitCondition": {
            "Type": "AWS::CloudFormation::WaitCondition",
            "DependsOn": "rccAppServerLaunchConfig",
            "Properties": {
                "Handle": {
                    "Ref": "rccAppServerLCWaitHandle"
                },
                "Timeout": "1800"
            },
            "Metadata": {
        ...
        "rccAppServerFleet": {
            "Properties": {
                ...
                "Tags": [
                    {
                        "Key": "Name",
                        "Value": "rccAppServerFleet",
                        "PropagateAtLaunch": "true"
                    }
                ],
                "LaunchConfigurationName": {
                    "Ref": "rccAppServerLaunchConfig"
                },
                "LoadBalancerNames": [
                    {
                        "Ref": "AppServerELB"
                                ...
                                "content": {
                                    "Fn::Join": [
                                        ...
                                        [
                                            "[cfn-auto-reloader-hook]\n",
                                            "triggers=post.update\n",
                                            "path=Resources.rccAppServerLaunchConfig.Metadata.AWS::CloudFormation::Init\n",
                                            "action=cfn-init.exe -v -c deploy -s ",
                                            {
                                                "Ref": "AWS::StackId"
                                            },
                                            " -r rccAppServerLaunchConfig",
                                            " --region ",
                                            {
                                                "Ref": "AWS::Region"
                                            },
        ...
        "rbcAppServerLCWaitCondition": {
            "Type": "AWS::CloudFormation::WaitCondition",
            "DependsOn": "rbcAppServerLaunchConfig",
            "Properties": {
                "Handle": {
                    "Ref": "rbcAppServerLCWaitHandle"
                },
                "Timeout": "1800"
            },
            "Metadata": {
        ...
        "rbcAppServerFleet": {
            "Properties": {
                ...
                "Tags": [
                    {
                        "Key": "Name",
                        "Value": "rbcAppServerFleet",
                        "PropagateAtLaunch": "true"
                    }
                ],
                "LaunchConfigurationName": {
                    "Ref": "rbcAppServerLaunchConfig"
                },
                "LoadBalancerNames": [
                    {
                        "Ref": "AppServerELB"
                                ...
                                "content": {
                                    "Fn::Join": [
                                        ...
                                        [
                                            "[cfn-auto-reloader-hook]\n",
                                            "triggers=post.update\n",
                                            "path=Resources.rbcAppServerLaunchConfig.Metadata.AWS::CloudFormation::Init\n",
                                            "action=cfn-init.exe -v -c deploy -s ",
                                            {
                                                "Ref": "AWS::StackId"
                                            },
                                            " -r rbcAppServerLaunchConfig",
                                            " --region ",
                                            {
                                                "Ref": "AWS::Region"
                                            },
        ...
        "rpcAppServerLCWaitCondition": {
            "Type": "AWS::CloudFormation::WaitCondition",
            "DependsOn": "rpcAppServerLaunchConfig",
            "Properties": {
                "Handle": {
                    "Ref": "rpcAppServerLCWaitHandle"
                },
                "Timeout": "1800"
            },
            "Metadata": {
        ...
        "rpcAppServerFleet": {
            "Properties": {
                ...
                "Tags": [
                    {
                        "Key": "Name",
                        "Value": "rpcAppServerFleet",
                        "PropagateAtLaunch": "true"
                    }
                ],
                "LaunchConfigurationName": {
                    "Ref": "rpcAppServerLaunchConfig"
                },
                "LoadBalancerNames": [
                    {
                        "Ref": "AppServerELB"
                                ...
                                "content": {
                                    "Fn::Join": [
                                        ...
                                        [
                                            "[cfn-auto-reloader-hook]\n",
                                            "triggers=post.update\n",
                                            "path=Resources.rpcAppServerLaunchConfig.Metadata.AWS::CloudFormation::Init\n",
                                            "action=cfn-init.exe -v -c deploy -s ",
                                            {
                                                "Ref": "AWS::StackId"
                                            },
                                            " -r rpcAppServerLaunchConfig",
                                            " --region ",
                                            {
                                                "Ref": "AWS::Region"
                                            },
